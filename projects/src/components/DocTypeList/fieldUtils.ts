...
export function getCellType(field: DocField) {
	...
	return {
		...
		isDate: DATE_FIELD_TYPES.includes(fieldtype as any),
		isNumeric:
...
export function truncateText(text: any, maxLength: number = TEXT_TRUNCATE_LENGTH): string {
...
export function formatCurrency(value: any, currency: string = DEFAULT_CURRENCY): string {
